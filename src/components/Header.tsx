      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center">
          <Link to="/" className="flex items-center">
            ...
            />
            <span className="text-2xl font-semibold text-gray-800">Box of Wishes</span>
          </Link>
        </div>

        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center space-x-6">
          <Link to="/" className="text-gray-700 hover:text-pastel-pink transition-colors">Home</Link>
          <div className="group relative">
            <span className="text-gray-700 hover:text-pastel-pink transition-colors cursor-pointer">Shop by Category</span>
            <div className="absolute left-0 mt-2 w-60 bg-white shadow-lg rounded-md py-2 hidden group-hover:block">
              <Link to="/category/cake-boxes" className="block px-4 py-2 hover:bg-pastel-pink/10">Cake Boxes</Link>
              <Link to="/category/brownie-boxes" className="block px-4 py-2 hover:bg-pastel-pink/10">Brownie Boxes</Link>
              <Link to="/category/cupcake-holders" className="block px-4 py-2 hover:bg-pastel-pink/10">Cupcake Holders</Link>
              <Link to="/category/festive-custom" className="block px-4 py-2 hover:bg-pastel-pink/10">Festive & Custom Orders</Link>
              <Link to="/category/ribbons" className="block px-4 py-2 hover:bg-pastel-pink/10">Ribbons & Accessories</Link>
            </div>
          </div>
          <Link to="/custom-orders" className="text-gray-700 hover:text-pastel-pink transition-colors">Custom Orders</Link>
          <Link to="/gallery" className="text-gray-700 hover:text-pastel-pink transition-colors">Gallery</Link>
          <Link to="/about" className="text-gray-700 hover:text-pastel-pink transition-colors">About Us</Link>
          <Link to="/contact" className="text-gray-700 hover:text-pastel-pink transition-colors">Contact</Link>
        </nav>

        <div className="hidden md:flex items-center space-x-4">
          <a href="https://www.instagram.com/box_of_wishes/" target="_blank" rel="noopener noreferrer">
            <Instagram className="h-5 w-5 text-gray-700 hover:text-pastel-pink transition-colors" />
          </a>
        ...
        <nav className="md:hidden bg-white py-4 px-6 shadow-inner">
          <div className="flex flex-col space-y-4">
            ...
            <div className="pt-4 flex items-center justify-between">
              <a href="https://www.instagram.com/box_of_wishes/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2">
